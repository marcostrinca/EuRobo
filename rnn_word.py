...
# Target log path
logs_path = 'logs/rnn_words'
writer = tf.summary.FileWriter(logs_path)

# Text file containing words for training
training_file = 'Data/_Portugue_Literature_Dataset.txt'
...
# import text
text = open(training_file, encoding='utf8').read()
# print(text[:500])
...
print ('qdd de palavras únicas:', vocab_size)
