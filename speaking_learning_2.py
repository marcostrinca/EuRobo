...
# import text
text = open('data/_rnn_saudacoes_mini.txt', encoding='utf8').read()
...
weights = {
    'out': tf.Variable(tf.random_normal([n_hidden2, vocab_size]))
}
biases = {
...
def RNN(x, weights, biases):
    ...
    rnn_cell = rnn.MultiRNNCell([rnn.BasicLSTMCell(n_hidden1),rnn.BasicLSTMCell(n_hidden2)])
